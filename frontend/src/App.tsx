...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-indigo-950 text-gray-100">
      {/* Header */}
      <header className="bg-black/80 backdrop-blur-xl border-b border-cyan-500/30 py-6 px-10 flex justify-between items-center shadow-xl">
      ...
      <div className="flex h-[calc(100vh-96px)]">
        {/* Sidebar */}
        <div className="w-72 bg-black/70 backdrop-blur-lg border-r border-cyan-500/20 p-6 flex flex-col gap-4">
        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          {error && (
            <div className="bg-red-900/60 border border-red-500 text-red-100 p-6 rounded-xl mb-8 max-w-4xl mx-auto">
          ...
          {activeTab === 'tree' && treeData && treeData.length > 0 && (
            <div>
              <h2 className="text-3xl font-bold mb-8 text-cyan-300">Project Structure</h2>
          ...
          {activeTab === 'analysis' && analysis && (
            <div>
              <h2 className="text-3xl font-bold mb-8 text-cyan-300">Analysis Results</h2>

              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-10">
                <div className="bg-gradient-to-br from-cyan-900/80 to-cyan-700/80 p-6 rounded-2xl shadow-lg border border-cyan-500/30 text-center">
                  <p className="text-lg text-cyan-200 mb-1">Nodes</p>
                  <p className="text-5xl font-bold text-white">{analysis.metrics.nodes_count}</p>
                </div>
                <div className="bg-gradient-to-br from-purple-900/80 to-purple-700/80 p-6 rounded-2xl shadow-lg border border-purple-500/30 text-center">
                ...
                <div className="bg-gradient-to-br from-green-900/80 to-green-700/80 p-6 rounded-2xl shadow-lg border border-green-500/30 text-center">
                ...
                <div className="bg-gradient-to-br from-red-900/80 to-red-700/80 p-6 rounded-2xl shadow-lg border border-red-500/30 text-center">
                ...
                <div className="bg-gradient-to-br from-indigo-900/80 to-indigo-700/80 p-6 rounded-2xl shadow-lg border border-indigo-500/30 text-center">
                ...
                <div className="bg-gradient-to-br from-amber-900/80 to-amber-700/80 p-6 rounded-2xl shadow-lg border border-amber-500/30 text-center">
          ...
          {activeTab === 'graph' && graph.nodes.length > 0 && (
            <div>
              <h2 className="text-3xl font-bold mb-8 text-cyan-300">Communication Graph</h2>
